 ...
 * @author maxim
 */
public class VueFileImpl extends XmlFileImpl implements FileReferenceResolver {
    public VueFileImpl(FileViewProvider provider) {
        this(provider, VueParserDefinition.elementType);
    }

    public VueFileImpl(FileViewProvider provider, IFileElementType type) {
        super(provider, type);
    }

    public String toString() {

        return "VueFile:" + getName();
    }
